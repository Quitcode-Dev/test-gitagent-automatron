...
function ToastClose({
  ...
  return (
    <ToastPrimitives.Close
      ...
      className={cn(
        "text-foreground/50 hover:text-foreground group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600 absolute top-1 right-1 rounded-md p-1 opacity-0 transition-opacity focus:ring-2 focus:ring-offset-2 focus:outline-hidden group-hover:opacity-100",
        className
      )}
      toast-close=""
      {...props}
